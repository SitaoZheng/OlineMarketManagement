...
function deleteCategory(id, categoryName) {
    if (confirm(`Are you sure you want to delete "${categoryName}"? This operation is irrevocable`)) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function showEditForm(row) {
        ...
        editForm.querySelector('input[name="editCategory"]').value = categoryName;
        editForm.querySelector('input[name="editId"]').value = categoryId;
